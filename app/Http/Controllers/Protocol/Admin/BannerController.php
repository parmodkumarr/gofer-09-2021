...
class BannerController extends Controller
{
    public function bannerlist(Request $request)
    {
        ...
        $city = DB::connection('mysql_sec')->table('banner')
                ->get();
                
        return view('protocol.admin.banner.bannerlist', compact('title','city','admin','logo'));    
    ...
    public function banner(Request $request)
    {
        ...
        return view('protocol.admin.banner.addbanner', compact('title','city','admin','logo'));    
    ...
    public function banneradd(Request $request)
    {
        ...
        $this->validate(
    	 ...
    	 $insert = DB::connection('mysql_sec')->table('banner')
                    ->insert([
                        'banner_name'=>$banner,
                        'banner_image'=>$image
                        ]);
    ...
    public function banneredit(Request $request)
    {
        ...
        return view('protocol.admin.banner.banneredit', compact('title','city','admin','logo'));    
    ...
    public function bannerupdate(Request $request)
    {
       ...
       $old_reward_image=$request->old_image;
        ...
        $getBanner = DB::connection('mysql_sec')->table('banner')
                        ->where('banner_id', $banner_id)
                        ->first();
   ...
   if($insert){
    ...
    public function bannerdelete(Request $request)
    {
    	...
    	$delete=DB::connection('mysql_sec')->table('banner')->where('banner_id',$banner_id)->delete();
        if($delete){
