   ...
   public function bulkup(Request $request)
    {
    	...
    	return view('protocol.admin.product.bulkupload', compact('title',"admin", "logo"));
    }
       ...
       $this->validate(
          ...
          $count=0;
            ...
            while($csv_line = fgetcsv($fp,1024))
            {
                ...
                $inserted = DB::connection('mysql_sec')->table('product')->insertGetId($data);
                 $data1 = array(
                     'product_id'=>$inserted,
                ...
                $inserted1 = DB::connection('mysql_sec')->table('product_varient')->insertGetId($data1);
