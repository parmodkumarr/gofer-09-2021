...
class DealController extends Controller
{
    public function list(Request $request)
    {
    	...
    	return view('protocol.admin.deal_product.list', compact('title',"admin", "logo","deal_p","currentdate"));
    }
        ...
        $title = "Add Deal";
    	 ...
    	 $admin= DB::connection('mysql_sec')->table('admin')
    	  ...
    	  $logo = DB::connection('mysql_sec')->table('tbl_web_setting')
           ...
           $deal = DB::connection('mysql_sec')->table('product_varient')
                ->join('product','product_varient.product_id','=','product.product_id')
                ->get();
        
        
        
        return view('protocol.admin.deal_product.add',compact("deal", "admin_email","logo", "admin", "title"));
     }
     ...
     public function AddNewDeal(Request $request)
    {
        ...
        $insertCategory = DB::connection('mysql_sec')->table('deal_product')
                            ->insert([
    ...
    public function EditDeal(Request $request)
    {
        ...
        return view('protocol.admin.deal_product.edit',compact("deal_p","admin_email","admin","logo","deal", "title"));
    }
    ...
    public function UpdateDeal(Request $request)
    {
       ...
       $varient_id = $request->varient_id;
        ...
        $updateDeal = DB::connection('mysql_sec')->table('deal_product')
                    ->where('deal_id', $deal_id)
                            ->update([
                                'varient_id'=>$varient_id,
                                'deal_price'=>$deal_price,
 ...
 public function DeleteDeal(Request $request)
    {
    	...
    	$delete=DB::connection('mysql_sec')->table('deal_product')->where('deal_id',$deal_id)->delete();
        if($delete)
        {
