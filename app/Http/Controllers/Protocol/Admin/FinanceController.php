...
class FinanceController extends Controller
{
    ...
    public function finance(Request $request)
    {
         ...
         $total_earnings=DB::connection('mysql_sec')->table('store')
                           ...
                           ->select('store.store_id','store.store_name', 'store.phone_number','store.address','store.email','store_earning.paid',DB::connection('mysql_sec')->raw('SUM(orders.total_price)-SUM(orders.total_price)*(store.admin_share)/100 as sumprice'))
