...
class WalletController extends Controller
{
   ...
   public function walletamount(Request $request)
    {  
        ...
        $wallet = DB::connection('mysql_sec')->table('users')
                ->select('wallet')
    ...
    { 
        ...
        $user_id = $request->user_id;
        $wallet_amt = DB::connection('mysql_sec')->table('users')
                    ->select('wallet')
                    ->where('user_id', $user_id)
                    ->first();
...
if($recharge_status == 'success'){
             $wallet_amt = DB::connection('mysql_sec')->table('users')
              ...
              $insert=  DB::connection('mysql_sec')->table('wallet_recharge_history')
    ...
    { 
       ...
       $last = DB::connection('mysql_sec')->table('wallet_recharge_history')
    ...
    { 
        $user_id = $request->user_id;
        $show =  DB::connection('mysql_sec')->table('wallet_recharge_history')
