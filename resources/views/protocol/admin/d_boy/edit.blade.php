                ...
                <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="autocomplete"> Delivery Boy Address </label>
                            <input id="longitude" type="hidden" name="lng" value="{{$d_boy->lng}}">
                              <input id="latitude" type="hidden" name="lat" value="{{$d_boy->lat}}">
                            <input class="form-control" id="autocomplete" type="text" name="boy_loc" value="{{$d_boy->boy_loc}}">
                        </div>  
                      </div>
                    </div>
                {{-- 
                    ...
                    <div class="col-md-12">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="city" class="form-control" value="{{$d_boy->boy_city}}">
                        </div>
                      </div>  
                    </div>
                  </div>
...
{{-- javascript code --}}
<script src="https://maps.google.com/maps/api/js?key={{$map}}&libraries=places" type="text/javascript"></script>
<script>
