...
.form-group .chosen-container.chosen-container-multi#select2_chosen{
  width: 100%!important;
}
</style> 
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group pull-right">
                          ...
                          <a href="{{route('section.type.list')}}" ><button type="button" class="btn btn-primary">Section Types &nbsp( {{$totalSectionTypes}} )</button></a>
                        </div>
                      </div>
                          ...
                          <div class="form-group">
                                  ...
                                  <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                      <a href="{{route('edit.section',$row->id)}}" >{{$row->name}}</a>
                                      <div class="">
                                      </div>
                                      <div class="">
                                        @if($row->is_active==1)
                                        <a style="color:green; font-size: larger;" href="{{route('toggle.section.status',$row->id)}}" > {{__('Visible')}} </a>
                                        @elseif($row->is_active==0)
                                        <a style="color:red; font-size: larger;" href="{{route('toggle.section.status',$row->id)}}" > {{__('Hidden')}} </a>
                                        @endif
                                      </div>
                                      ...
                                      <div class="">
                                          <a class="btn btn-danger __delete" href="javascript:void(0)" data-route="{{route('deletehomeDesign')}}" data-id="{{$row->id}}" data-heading="Are you sure?" data-message="you want to permanently delete this item">Delete</a>
                                      </div>
                                    </li>
                                    @endforeach
