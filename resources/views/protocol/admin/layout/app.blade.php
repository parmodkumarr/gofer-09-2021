...
<html lang="en">
  <head>
      ...
      <link src="{{url('assets/css/bootstrap-datetimepicker.min.css')}}">
...
<body class="">
    <div class="wrapper">
      <!--sidebar-->
       @include('protocol.admin.layout.sidebar')
      <div class="main-panel">
          <!-- Navbar -->
          @include('protocol.admin.layout.nav')
          <!-- End Navbar -->
        <div class="content">
           @yield('content')
        </div>
        <!--footer-->
         @include('protocol.admin.layout.footer')
      </div>
