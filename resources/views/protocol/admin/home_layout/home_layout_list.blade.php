...
<div class="col-lg-12">  
     <a href="{{route('home.layout.form.view')}}" class="btn btn-primary ml-auto" style="width:10%;float:right;padding: 3px 0px 3px 0px;"><i class="material-icons">add</i>Create Layout</a>
</div>     
<div class="col-lg-12">
<div class="card">    
    ...
    <thead>
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
                      <th>Section Layout Type</th>
                      <th>Active</th>
                      <th>Action</th>
                    </thead>
                    <tbody>
                         @if(count($homeLayouts)>0)
                          @php $i=1; @endphp
                          @foreach($homeLayouts as $row)
                            <tr>
