                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{$coupon->coupon_code}}" name="coupon_code" class="form-control" readonly=true>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{$coupon->start_date}}" name="valid_to" class="form-control datetimepicker">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <p class="card-description">Valid From</p>
                          <input type="text" value="{{$coupon->end_date}}" name="valid_from" class="form-control datetimepicker">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm img" id="exampleFormControlSelect3" value="{{$coupon->type}}"  name="coupon_type">
                        ...
                        <option value="1" @if($coupon->type == '1') selected @endif>Flat</option>
                        <option value="2" @if($coupon->type == '2' || $coupon->type == '2') selected @endif>Percentage</option>
                      </select>
