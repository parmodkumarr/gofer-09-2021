            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('Bulkaddcoupon')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Number of Coupon</label>
                          <input type="number" name="no_of_coupon" class="form-control" value=0>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <p class="card-description">Coupon Length</p>
                          <input type="number" name="coupon_Length" class="form-control" value=0>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <p class="card-description">Prefix</p>
