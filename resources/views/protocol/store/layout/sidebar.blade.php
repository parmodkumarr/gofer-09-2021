...
<div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item {{ (request()->is('store/home/design')) ? 'active' : '' }}">
            <a class="nav-link" href="{{route('store.homeDesign')}}">
              <i class="material-icons">home</i>
              <p>Home Design</p>
            </a>
          </li>

          <li class="nav-item {{ (request()->is('store/all/categories')) ? 'active' : '' }}">
            <a class="nav-link" href="{{route('store.all.categories')}}">
              <i class="material-icons">home</i>
              <p>All Categories</p>
            </a>
          </li>
          <li class="nav-item {{ (request()->is('add/timeslot')) ? 'active' : '' }}">
            <a class="nav-link" href="{{route('stor_add_timeslot')}}">
              <i class="material-icons">home</i>
              <p>Time Slot</p>
            </a>
          </li>
