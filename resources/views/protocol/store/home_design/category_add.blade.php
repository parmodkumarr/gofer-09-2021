                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('store.update.section')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <a href="javascript:void(0)" id="onloadClick" onclick="storeCategoryId();" style=" font-weight: 900; font-size: larger;"> Search </a>
                    </div>
      ...
      function getContent(productId){
          ...
          if(product_id==''){
            ...
            jQuery.ajax({
                ...
                url: "{{ route('store.save.category.content') }}",
                method: 'post',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
