            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                      <div class="col-md-12 ">
                        <button type="button" class="btn pull-right btn-primary" ><a href="{{route('home.layout.form.view.sub.category',$section->id)}}" style="color: white;" >Add Layout</a></button>
                      </div>
                  </div>
                  <br>
                  <form class="forms-sample" action="{{route('store.update.section')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-md-6" class="on_select_flat">
                        <div class="form-group">
                          <label class="bmd-label-floating">Discount Amount</label>
                          <input type="number" id="discount_amount" name="discount_amount" value="{{$section->discount_amount}}" class="form-control" disabled>
                        </div>
                      </div> -->
                    </div>
                    <br>
                    ...
                    <div class="row" style="display: none;" >
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select name="city" id="select1" class="form-control select2">
    ...
    <script type="text/javascript">
      ...
      $(function(){
          $('#select1').change(function(){
            ...
            jQuery.ajax({
              url: "{{ route('store.get.sub.category') }}",
              method: 'post',
              headers: {
                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              },
        ...
        if($(this).val() =='2'){
          ...
          // $('#discount_amount2').prop("disabled", true);
          // $('.on_select_percentage').css('display','none'); 
          // $('.on_select_flat').css('display','block');
          ...
          // $('.on_select_flat').css('display','none');
          // $('#discount_amount2').prop("disabled", false);
          // $('.on_select_percentage').css('display','block');
          // var amount = "{{$section->discount_amount}}";
          // if(amount>100){
  ...
  e.preventDefault();
      ...
      function getContent(productId){
            if(product_id==''){
              ...
              jQuery.ajax({
                url: "{{ route('store.save.subcategory.content') }}",
                method: 'post',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
