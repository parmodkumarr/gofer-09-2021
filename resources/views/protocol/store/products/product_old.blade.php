                  ...
                  <h4 class="card-title">Update price/mrp</h4>
                    ...
                    <tr>
                        ...
                        <td><b>type : </b>
                          ...
                          @endif
                          <br>
                        <b>amount : </b>{{$sel->store_discount_amount}}</td>
                         ...
                         <form class="forms-sample" action="{{route('store_discount_update', $sel->p_id)}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-md-8" style="float:left">
                             <div class="form-group">
                              ...
                              <!-- <input type="number" step="0.10" name="mrp" class="form-control" value="0"> -->
                            {{--
                              @if( $sel->discount_type ==1)
                                <input type="text" readonly="true" value="Percentage" name="discount_type" class="form-control" value="0">
                              @elseif($sel->discount_type == "Flat")
                                <input type="text" readonly="true" value="Flat" name="discount_type" class="form-control" value="0">
                              @endif --}}
