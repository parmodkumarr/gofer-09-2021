...
<table class="display table-responsive table" id="myTable">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            @if($ords->payment_status == 2)
            <td>{{$ords->payment_method}} | Paid </td>
            @endif
             @if($ords->payment_status == 0)
            <td>{{$ords->payment_method}} | Failed </td>
            @endif
             @if($ords->payment_status == 1)
            <td>Cash on Delivery</td>
            @endif
                <td class="td-actions text-right">
         @if($ords->order_status == 2)
               ...
               Reject
                ...
                @if($ords->order_status == 5)
                <p style="color:orange !important">Confirmed</p>
                @endif
                @if($ords->order_status == 3)
        		...
        		<div class="modal-content">
        			...
        			<table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                      <thead>
                        ...
                        <th>Order_qty</th>
                        <th>Price</th>
                             @if($ords->order_status == 1) <th>I don't have</th> @endif
                        </tr>
                      </thead>
