<div class="fixed-top  shadow-sm">
  ...
  <p class="header_store">
    <span class="header_span">Growcer–Online Grocery Store!</span>
    <span class="header_curr">$Currency</span>
  </p>
 <nav class="navbar navbar-expand-sm navbar-light bg-white" style="margin-top: -16px;">
  ...
  <p style="margin-top: -5px;">Welcome @if(isset($cust->user_name)) {{$cust->user_name}} @endif &nbsp; <img src="{{url('webstyle/image/panga.PNG')}}" height="35" style="border-radius: 10px;"></p>
